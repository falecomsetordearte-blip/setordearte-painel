...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const verificationLink = `https://setordearte-painel-git-desenvolvimento-diors-projects-0dc3c14d.vercel.app/verificacao?token=${sessionToken}&action=ativar_conta`;
